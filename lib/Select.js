...
var Select = /*#__PURE__*/function (_Component) {
  ...
  function Select(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onChange", function (newValue, actionMeta) {
      ...
      onChange(newValue, _objectSpread(_objectSpread({}, actionMeta), {}, {
        name: name
      }));
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "announceAriaLiveContext", function (_ref3) {
      ...
      _this.setState({
        ariaLiveContext: (0, _index2.instructionsAriaMessage)(event, _objectSpread(_objectSpread({}, context), {}, {
  ...
  _createClass(Select, [{
    ...
    // Menu Options
    // ==============================
    function buildMenuOptions(props, selectValue) {
      var _this3 = this;
    ...
    value: function renderInput() {
      ...
      if (!isSearchable) {
        ...
        return /*#__PURE__*/_react.default.createElement(_index.DummyInput, _extends({
          id: id,
    ...
    value: function renderPlaceholderOrValue() {
      ...
      if (!this.hasValue() || !controlShouldRenderValue) {
        return inputValue ? null : /*#__PURE__*/_react.default.createElement(Placeholder, _extends({}, commonProps, {
          key: "placeholder",
          isDisabled: isDisabled,
          isFocused: isFocused
        }), placeholder);
      ...
      if (isMulti) {
        var selectValues = selectValue.map(function (opt) {
          ...
          return /*#__PURE__*/_react.default.createElement(MultiValue, _extends({}, commonProps, {
            components: {
      ...
      return /*#__PURE__*/_react.default.createElement(SingleValue, _extends({}, commonProps, {
        data: singleValue,
        isDisabled: isDisabled
    ...
    value: function renderClearIndicator() {
      ...
      return /*#__PURE__*/_react.default.createElement(ClearIndicator, _extends({}, commonProps, {
    ...
    value: function renderLoadingIndicator() {
      ...
      return /*#__PURE__*/_react.default.createElement(LoadingIndicator, _extends({}, commonProps, {
        innerProps: innerProps,
        isDisabled: isDisabled,
        isFocused: isFocused
      }));
    ...
    value: function renderIndicatorSeparator() {
      ...
      var isFocused = this.state.isFocused;
      return /*#__PURE__*/_react.default.createElement(IndicatorSeparator, _extends({}, commonProps, {
        isDisabled: isDisabled,
        isFocused: isFocused
      }));
    }
    ...
    value: function renderDropdownIndicator() {
      ...
      return /*#__PURE__*/_react.default.createElement(DropdownIndicator, _extends({}, commonProps, {
        innerProps: innerProps,
        isDisabled: isDisabled,
        isFocused: isFocused
      }));
    ...
    value: function renderMenu() {
      ...
      var render = function render(props) {
        ...
        return /*#__PURE__*/_react.default.createElement(Option, _extends({}, commonProps, props, {
          isFocused: isFocused
      ...
      if (this.hasOptions()) {
        menuUI = menuOptions.render.map(function (item) {
          if (item.type === 'group') {
            var type = item.type,
                group = _objectWithoutProperties(item, _excluded);

            var headingId = "".concat(item.key, "-heading");
            return /*#__PURE__*/_react.default.createElement(Group, _extends({}, commonProps, group, {
      ...
      var menuElement = /*#__PURE__*/_react.default.createElement(_Menu.MenuPlacer, _extends({}, commonProps, menuPlacementProps), function (_ref6) {
        var ref = _ref6.ref,
            _ref6$placerProps = _ref6.placerProps,
            placement = _ref6$placerProps.placement,
            maxHeight = _ref6$placerProps.maxHeight;
        return /*#__PURE__*/_react.default.createElement(Menu, _extends({}, commonProps, menuPlacementProps, {
          innerRef: ref,
          innerProps: {
          ...
          isLoading: isLoading,
          placement: placement
        }), /*#__PURE__*/_react.default.createElement(_index.ScrollCaptor, {
          isEnabled: captureMenuScroll,
          onTopArrive: onMenuScrollToTop,
          onBottomArrive: onMenuScrollToBottom
        }, /*#__PURE__*/_react.default.createElement(_index.ScrollBlock, {
          isEnabled: menuShouldBlockScroll
        }, /*#__PURE__*/_react.default.createElement(MenuList, _extends({}, commonProps, {
      ...
      return menuPortalTarget || menuPosition === 'fixed' ? /*#__PURE__*/_react.default.createElement(MenuPortal, _extends({}, commonProps, {
    ...
    value: function renderLiveRegion() {
      ...
      return /*#__PURE__*/_react.default.createElement(_index.A11yText, {
        "aria-live": "assertive"
      }, /*#__PURE__*/_react.default.createElement("p", {
        id: "aria-selection-event"
      }, "\xA0", this.state.ariaLiveSelection), /*#__PURE__*/_react.default.createElement("p", {
        id: "aria-context"
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react.default.createElement(SelectContainer, _extends({}, commonProps, {
        className: className,
        innerProps: {
          id: id,
        ...
        isDisabled: isDisabled,
        isFocused: isFocused
      }), this.renderLiveRegion(), /*#__PURE__*/_react.default.createElement(Control, _extends({}, commonProps, {
      ...
      }), /*#__PURE__*/_react.default.createElement(ValueContainer, _extends({}, commonProps, {
        isDisabled: isDisabled
      }), this.renderPlaceholderOrValue(), this.renderInput()), /*#__PURE__*/_react.default.createElement(IndicatorsContainer, _extends({}, commonProps, {
        isDisabled: isDisabled
